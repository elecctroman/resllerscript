  ...
  "error_code": "UNAUTHORIZED"
    ...
    <div class="doc-card">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2 class="h4 mb-0">GET /api/v1/user</h2>
...
<pre><code>{
  ...
  "message": "Kullanıcı bilgileri getirildi."
    ...
    <div class="doc-card">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2 class="h4 mb-0">GET /api/v1/products</h2>
            <span class="endpoint-badge endpoint-get">GET</span>
        </div>
...
<pre><code>{
  ...
  "message": "Ürün listesi başarıyla getirildi."
    ...
    <div class="doc-card">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2 class="h4 mb-0">POST /api/v1/orders</h2>
...
<pre><code>{
  ...
  "message": "Siparişiniz otomatik teslimat için kuyruğa alındı. Sipariş durumunu kısa süre içinde siparişlerim ekranından takip edebilirsiniz."
    ...
    <div class="doc-card">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2 class="h4 mb-0">GET /api/v1/orders</h2>
            <span class="endpoint-badge endpoint-get">GET</span>
        </div>
...
<pre><code>{
  ...
  "message": "Sipariş geçmişi listelendi."
    ...
    <div class="doc-card">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2 class="h4 mb-0">GET /api/v1/orders/{id}</h2>
            <span class="endpoint-badge endpoint-get">GET</span>
        </div>
