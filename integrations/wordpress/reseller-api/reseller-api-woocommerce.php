...
if (!class_exists('Reseller_API_WooCommerce_Plugin')) {
    final class Reseller_API_WooCommerce_Plugin
    {
        ...
        const VERSION    = '1.1.0';
        const MENU_SLUG  = 'reseller-api-bridge';

        /**
         * @var Reseller_API_WooCommerce_Plugin|null
         */
        ...
        /**
         * Retrieve a bootstrapped instance of the plugin.
         *
         * @return Reseller_API_WooCommerce_Plugin
         */
         ...
         * @return string
         */
        public function get_client_domain()
        {
            $settings = $this->get_settings();
            $domain   = isset($settings['client_domain']) ? trim((string) $settings['client_domain']) : '';
        ...
        /**
         * Expose the client helper for other components.
         *
         * @return Reseller_API_Client
         */
...
{
    $GLOBALS['reseller_api_plugin'] = Reseller_API_WooCommerce_Plugin::instance();
}

reseller_api_init_plugin();
