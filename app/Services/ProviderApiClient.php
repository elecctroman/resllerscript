...
final class ProviderApiClient
{
    private const DRIVER_DEFAULTS = array(
        'generic' => array(
            ...
            'status_endpoint' => '/api/v1/profile',
            'query_key' => 'apikey',
            'auth_scheme' => 'bearer',
        ),
        'netgsm' => array(
    ...
    {
        $endpoint = self::resolveEndpoint($provider, 'products_endpoint', '/api/v1/products');
    ...
    {
        $endpoint = self::resolveEndpoint($provider, 'status_endpoint', '/api/v1/profile');
    ...
    {
        $endpoint = self::resolveEndpoint($provider, 'orders_endpoint', '/api/v1/orders');
