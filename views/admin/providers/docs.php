<div class="provider-api-docs">
    ...
    <div class="note">
        <strong>Adres formatı:</strong> Genel Ayarlar bölümüne <em>https://partner.lotuslisans.com.tr</em> gibi <strong>/api eki olmadan</strong> ana etki alanını girin. Sistem uç noktaları otomatik olarak <code>/api/...</code> ile tamamlar ve böylece <code>/api/api/...</code> yönlendirme döngüleri oluşmaz.
    </div>
