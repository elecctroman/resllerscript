        ...
        <div class="dj-bar__inner">
            ...
            <nav class="dj-nav" aria-label="Ana menü">
                <div class="dj-dd" data-dj-dropdown>
                    <button class="dj-link dj-dd__btn" type="button" data-dj-trigger aria-haspopup="true" aria-expanded="false" aria-controls="djCategoriesMenu">
                        Kategoriler
            ...
            <div class="dj-actions">
                ...
                <?php if ($isLoggedIn): ?>
                    <div class="dj-account" data-dj-dropdown>
                        <button class="dj-btn dj-ghost" type="button" data-dj-trigger aria-haspopup="true" aria-expanded="false" aria-controls="djAccountMenu">
                            <span class="dj-account__label">Hesabım</span>
                            <span class="dj-chev" aria-hidden="true"></span>
                        </button>
                        <div class="dj-dd__menu" id="djAccountMenu" role="menu" hidden>
                            <p class="dj-dd__hello">Hoş geldin, <?= htmlspecialchars($displayName, ENT_QUOTES, 'UTF-8') ?></p>
                            <a class="dj-dd__item" role="menuitem" href="<?= htmlspecialchars($accountUrl, ENT_QUOTES, 'UTF-8') ?>">Hesabım</a>
                            <a class="dj-dd__item" role="menuitem" href="<?= htmlspecialchars($ordersUrl, ENT_QUOTES, 'UTF-8') ?>">Siparişlerim</a>
                            <form method="post" action="<?= htmlspecialchars($logoutAction, ENT_QUOTES, 'UTF-8') ?>" class="dj-dd__form">
                                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($logoutToken, ENT_QUOTES, 'UTF-8') ?>">
                                <button type="submit" class="dj-dd__item dj-dd__item--danger" role="menuitem">Çıkış Yap</button>
                            </form>
                        </div>
                    </div>
                <?php else: ?>
        ...
        <div class="dj-mobile__body">
            <?php if ($isLoggedIn): ?>
                <div class="dj-mobile__section">
                    ...
                    <a class="dj-mobile__link" href="<?= htmlspecialchars($accountUrl, ENT_QUOTES, 'UTF-8') ?>">Hesabım</a>
