    ...
    <div class="product-card__body">
        ...
        <div class="product-card__footer">
            ...
            <div class="product-actions">
                <form method="post" action="<?= htmlspecialchars(store_url('cart/add'), ENT_QUOTES, 'UTF-8') ?>" data-cart-add>
                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken, ENT_QUOTES, 'UTF-8') ?>">
                    <input type="hidden" name="product_id" value="<?= $productId ?>">
                    <input type="hidden" name="quantity" value="1">
                    <button type="submit" class="btn btn-primary btn-sm">Sepete Ekle</button>
                </form>
                <a href="<?php echo htmlspecialchars($productUrl, ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-outline-secondary btn-sm">Detay</a>
            </div>
        </div>
    </div>
</div>
