...
if (!$slides) {
    $slides = array(
        array(
            ...
            'cta' => 'PUBG Ürünleri',
            'url' => store_url('category.php?q=pubg'),
            'tag' => 'Sıcak Fırsat',
        ...
        array(
            ...
            'cta' => "Valorant'a Git",
            'url' => store_url('category.php?q=valorant'),
            'tag' => 'Yeni Sezon',
            'image' => theme_asset('img/placeholder-16x9.svg'),
        ),
        array(
            ...
            'cta' => 'Adobe Paketleri',
            'url' => store_url('category.php?q=adobe'),
            'tag' => 'Profesyoneller',
            'image' => theme_asset('img/placeholder-16x9.svg'),
        ),
    );
...
if (!$collections) {
    $collections = array(
        array('name' => 'CS2 Skinleri', 'description' => 'StatTrak & Koleksiyon setleri', 'url' => store_url('category.php?q=csgo')),
        array('name' => 'League of Legends', 'description' => 'RP paketleri & hazır hesaplar', 'url' => store_url('category.php?q=lol')),
        array('name' => 'Free Fire', 'description' => 'Elit Pass & elmas yüklemeleri', 'url' => store_url('category.php?q=freefire')),
        array('name' => 'Office 365', 'description' => 'Kurumsal ekipler için 365', 'url' => store_url('category.php?q=office365')),
        array('name' => 'Netflix UHD', 'description' => 'Ultra HD paylaşımlı hesaplar', 'url' => store_url('category.php?q=netflix')),
        array('name' => 'Semrush Pro', 'description' => 'SEO ajanslarına özel paketler', 'url' => store_url('category.php?q=semrush')),
    );
}
                ...
                <article class="hero-slide<?php echo $index === 0 ? ' is-active' : ''; ?>" data-carousel-slide>
                    ...
                    <div class="hero-content">
                        ...
                        <div class="d-flex flex-wrap gap-3 mt-3">
                            ...
                            <a class="btn btn-outline" href="<?php echo htmlspecialchars(store_url('category.php'), ENT_QUOTES, 'UTF-8'); ?>">Tüm Kategoriler</a>
                        </div>
                    </div>
                </article>
            <?php endforeach; ?>
