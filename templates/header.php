    ...
    if ($isAdminRole) {
        $adminSections = array(
            ...
            array(
                'heading' => 'Mağaza',
                'items' => array(
                    array('label' => 'Ana Sayfa Vitrin Ayarları', 'href' => '/admin/store/home-showcase.php', 'pattern' => '/admin/store/home-showcase.php', 'icon' => 'bi-columns-gap', 'roles' => array('super_admin', 'admin', 'content')),
                ),
            ),
            array(
        ...
        $resellerItems = array(
            array('label' => 'Kullanıcı Bilgilerim', 'href' => '/profile.php', 'pattern' => '/profile.php', 'icon' => 'bi-person'),
            array('label' => 'Siparişlerim', 'href' => '/orders.php', 'pattern' => '/orders.php', 'icon' => 'bi-receipt'),
            array('label' => 'Destek Taleplerim', 'href' => '/support.php', 'pattern' => '/support.php', 'icon' => 'bi-life-preserver'),
            array('label' => 'Şifre Değişikliği', 'href' => '/password-reset.php', 'pattern' => '/password-reset.php', 'icon' => 'bi-shield-lock'),
            array('label' => 'Çıkış Yap', 'href' => '/logout.php', 'pattern' => '/logout.php', 'icon' => 'bi-box-arrow-right'),
        );
