    ...
    if ($isAdminRole && $isAdminArea) {
        $adminSections = array(
            ...
            array(
                ...
                'items' => array(
                    array('label' => 'Ayarlar', 'href' => '/admin/providers/settings.php', 'pattern' => '/admin/providers/settings.php', 'icon' => 'bi-gear', 'roles' => array('super_admin', 'admin')),
                    array('label' => 'Lotus Ürünleri', 'href' => '/admin/providers/lotus-products.php', 'pattern' => '/admin/providers/lotus-products.php', 'icon' => 'bi-plug', 'roles' => array('super_admin', 'admin')),
                ),
            ),
            array(
                'heading' => 'WooCommerce',
