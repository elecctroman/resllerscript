        ...
        <header class="app-navbar navbar navbar-expand-lg navbar-dark" id="appNavbar" role="banner">
            <div class="container-fluid d-flex align-items-center gap-3">
                <a class="navbar-brand d-flex align-items-center" href="<?= $isAdminArea ? '/admin/dashboard.php' : '/dashboard.php' ?>">
                    <?php if ($siteLogoUrl): ?>
                        <img src="<?= Helpers::sanitize($siteLogoUrl) ?>" alt="<?= Helpers::sanitize($siteName) ?>" class="navbar-brand-logo me-2" height="32">
                    <?php endif; ?>
                    <div class="d-flex flex-column">
                        <span class="navbar-brand-title fw-semibold"><?= Helpers::sanitize($siteName) ?></span>
                        <?php if ($siteTagline): ?>
