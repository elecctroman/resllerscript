    ...
    <?php if ($user): ?>
        <aside class="app-sidebar" id="appSidebar">
            ...
            <nav class="sidebar-nav" id="sidebarNav">
                <?php foreach ($menuSections as $sectionIndex => $section): ?>
                    <?php
                    $sectionActive = false;
                    ...
                    $sectionId = 'sidebar-section-' . ($sectionIndex + 1);
                    ?>
                    <div class="sidebar-section">
                        <button class="sidebar-section-toggle <?= $sectionActive ? '' : 'collapsed' ?>" type="button" data-bs-toggle="collapse" data-bs-target="#<?= $sectionId ?>" aria-expanded="<?= $sectionActive ? 'true' : 'false' ?>" aria-controls="<?= $sectionId ?>">
                            <span class="sidebar-section-title"><?= Helpers::sanitize($section['heading']) ?></span>
                            <span class="sidebar-section-toggle-icon"><i class="bi bi-chevron-down"></i></span>
                        </button>
                        <div class="collapse <?= $sectionActive ? 'show' : '' ?>" id="<?= $sectionId ?>" data-bs-parent="#sidebarNav">
        ...
        <?php if ($user): ?>
            <header class="app-topbar d-flex align-items-center justify-content-between gap-3 flex-wrap">
                ...
                <div class="app-topbar-actions d-flex align-items-center flex-wrap gap-3 ms-lg-auto">
                    <?php if (Helpers::featureEnabled('balance')): ?>
                        <div class="app-balance-pill d-none d-lg-inline-flex align-items-center gap-2">
                    ...
                    <?php endif; ?>
                    <div class="dropdown">
                        <button class="btn btn-light btn-sm d-flex align-items-center gap-2 app-user-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <main class="app-content flex-grow-1">
            <div class="app-content-inner py-4">
                <div class="app-container">
                    <?php if ($user && Helpers::featureEnabled('balance')): ?>
                        <div class="d-lg-none mb-3">
                            <span class="badge text-bg-primary rounded-pill px-4 py-2">
