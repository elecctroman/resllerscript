    ...
    <?php if ($user): ?>
        <header class="app-navbar navbar navbar-expand-lg navbar-dark" id="appNavbar" role="banner">
            <div class="container-fluid app-navbar-container align-items-center justify-content-between">
                ...
                <button class="navbar-toggler border-0 ms-auto d-lg-none" type="button" data-bs-toggle="collapse" data-bs-target="#appNavbarNav" aria-controls="appNavbarNav" aria-expanded="false" aria-label="<?= Helpers::sanitize('Menüyü Aç') ?>">
                ...
                <div class="collapse navbar-collapse" id="appNavbarNav" role="navigation" aria-label="<?= Helpers::sanitize('Ana menü') ?>">
                    <div class="navbar-collapse-inner d-flex flex-column flex-lg-row align-items-lg-center w-100 gap-4">
                        <div class="navbar-center flex-grow-1 order-1 order-lg-1 w-100">
                        <?php if ($menuSections): ?>
                            <div class="navbar-menu-scroll" tabindex="0">
                                <ul class="navbar-nav ms-lg-3 align-items-lg-center justify-content-lg-start" role="menubar" aria-label="<?= Helpers::sanitize('Birincil menü') ?>">
                                        <?php if ($isAdminRole): ?>
                        ...
                        <div class="navbar-right navbar-utilities order-2 order-lg-2 d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center gap-3 ms-lg-auto w-100 w-lg-auto pt-3 pt-lg-0">
                            <?php if ($showLanguageSwitch): ?>
                                <div class="nav-language w-100 w-lg-auto">
                                    <label class="visually-hidden form-label" for="appLanguageSelect"><?= Helpers::sanitize('Dil') ?></label>
                            ...
                            <?php if ($showBalanceInfo): ?>
                                <div class="navbar-balance d-flex flex-column text-white-50 text-lg-end w-100 w-lg-auto">
                                    <span class="navbar-balance-label text-uppercase small mb-1 mb-lg-0"><?= Helpers::sanitize('Bakiye') ?></span>
                                    <span class="navbar-balance-amount fw-semibold text-white"><?= $userBalanceHtml ?></span>
                                </div>
                            <?php endif; ?>
