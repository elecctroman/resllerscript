    ...
    <?php if ($user): ?>
        <header class="app-navbar navbar navbar-expand-lg navbar-dark" id="appNavbar" role="banner">
            <div class="container-fluid app-navbar-container">
                ...
                <button class="navbar-toggler d-lg-none ms-auto" type="button" data-bs-toggle="collapse" data-bs-target="#appNavbarNav" aria-controls="appNavbarNav" aria-expanded="false" aria-label="<?= Helpers::sanitize('Menüyü Aç') ?>">
                ...
                <div class="collapse navbar-collapse" id="appNavbarNav" role="navigation" aria-label="<?= Helpers::sanitize('Ana menü') ?>">
                    <div class="navbar-collapse-inner d-flex flex-column flex-lg-row align-items-lg-center w-100 gap-4">
                        ...
                        <div class="navbar-right order-2 order-lg-2 d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center gap-3 ms-lg-auto ps-lg-4">
