    ...
    <?php if ($user): ?>
        <header class="app-navbar navbar navbar-expand-lg navbar-dark bg-primary" id="appNavbar" role="banner">
            <div class="container-fluid app-navbar-container align-items-center justify-content-between">
                ...
                <div class="collapse navbar-collapse justify-content-start" id="appNavbarNav" role="navigation" aria-label="<?= Helpers::sanitize('Ana menü') ?>">
                    ...
                    <?php endif; ?>
                    <div class="navbar-utilities d-flex align-items-center ms-auto flex-column flex-lg-row align-items-lg-center gap-3 mt-3 mt-lg-0 pt-3 pt-lg-0 w-100 w-lg-auto">
