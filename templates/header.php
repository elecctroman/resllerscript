    ...
    if ($isAdminRole && $isAdminArea) {
        $adminSections = array(
            ...
            array(
                ...
                'items' => array(
                    array('label' => 'WooCommerce İçe Aktar', 'href' => '/admin/woocommerce-import.php', 'pattern' => '/admin/woocommerce-import.php', 'icon' => 'bi-file-arrow-up', 'roles' => array('super_admin', 'admin', 'content')),
                    array('label' => 'WooCommerce Dışa Aktar', 'href' => '/admin/woocommerce-export.php', 'pattern' => '/admin/woocommerce-export.php', 'icon' => 'bi-file-arrow-down', 'roles' => array('super_admin', 'admin', 'content')),
