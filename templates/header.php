            ...
            <nav class="navbar navbar-expand-lg navbar-dark app-navbar">
                <div class="container-fluid px-3 px-xl-5">
                    ...
                    <div class="collapse navbar-collapse" id="appPrimaryNav">
                        <ul class="navbar-nav app-menu flex-column flex-lg-row gap-1 gap-lg-2 mb-3 mb-lg-0 pe-lg-4">
                        ...
                        <div class="app-navbar-actions d-flex flex-column flex-lg-row align-items-start align-items-lg-center gap-3 ms-lg-auto">
                            ...
                            <?php if ($showLanguageSwitch): ?>
                                <div class="app-language-switcher w-100 w-lg-auto">
