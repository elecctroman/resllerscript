    ...
    if ($isAdminRole && $isAdminArea) {
        $adminSections = array(
            ...
            array(
                'heading' => 'WhatsApp',
                'items' => array(
                    array('label' => 'Gateway & QR', 'href' => '/admin/whatsapp.php', 'pattern' => '/admin/whatsapp.php', 'icon' => 'bi-qr-code', 'roles' => array('super_admin', 'admin')),
                    array('label' => 'Oturumlar', 'href' => '/admin/whatsapp_sessions.php', 'pattern' => '/admin/whatsapp_sessions.php', 'icon' => 'bi-people', 'roles' => array('super_admin', 'admin')),
                    array('label' => 'Bildirim Abonelikleri', 'href' => '/admin/notification_subscriptions.php', 'pattern' => '/admin/notification_subscriptions.php', 'icon' => 'bi-bell', 'roles' => array('super_admin', 'admin')),
                ),
            ),
            array(
                'heading' => 'Denetim',
