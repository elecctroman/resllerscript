...
Bu depo, ePin, lisans ve dijital hesap satış süreçlerini yönetmek için geliştirilen bayi otomasyon yazılımını içerir. Sistem; çoklu dil ve para birimi desteği, kategori bazlı ürün kataloğu, favori ürün listeleri, stok bildirimi, talimat yönetimi ve zengin bayi duyuru mekanizması gibi özellikler sunar.
...
* Çoklu dil ve para birimi yönetimi (admin arayüzünden anlık güncellenebilir)
