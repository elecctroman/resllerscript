...
final class Schema
{
    ...
    private static function ensureMegaMenuTables(PDO $pdo): void
    {
        ...
        self::ensureColumn($pdo, 'mega_menu_items', 'custom_image', 'VARCHAR(255) NULL');
    ...
    private static function ensureUserProfilesTable(PDO $pdo): void
    {
        ...
        self::ensureColumn($pdo, 'user_profiles', 'updated_at', 'DATETIME NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP');
    }
