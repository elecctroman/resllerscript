        ...
        if ($action === 'profile') {
            ...
            if (!$errors) {
                try {
                    ...
                    if (!$errors) {
                        $pdo->prepare('UPDATE users SET name = :name, updated_at = NOW() WHERE id = :id')->execute(array(
                            'name' => $name,
                            'id' => $user['id'],
                        ));
            ...
            try {
                ...
                $successMessages[] = 'E-posta bildirim tercihlerin güncellendi.';
            } catch (\PDOException $exception) {
...
<div class="row g-4">
    <div class="col-12 col-lg-6">
        ...
        <div class="card border-0 shadow-sm mt-4">
            <div class="card-header bg-white">
                <h5 class="mb-0">E-posta Bildirimleri</h5>
                <small class="text-muted">Hangi bilgilendirmeleri almak istediğinizi seçin.</small>
            </div>
            <div class="card-body">
                <form method="post" class="vstack gap-3">
                    ...
                    <div class="form-check form-switch">
                        ...
                        <small class="text-muted d-block">Tamamlanan siparişler için teslimat detaylarını içeren e-posta alın.</small>
                    </div>
                    ...
                    <div class="form-check form-switch">
                        ...
                        <small class="text-muted d-block">Onaylanan bakiye taleplerinde tutar ve yöntem özetini e-posta ile al.</small>
                    </div>
                    ...
                    <div class="form-check form-switch">
                        ...
                        <small class="text-muted d-block">Destek ekibi talebinize yanıt verdiğinde e-posta bildirimi gönderilsin.</small>
                    </div>
