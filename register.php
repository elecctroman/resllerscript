...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (!$cryptomusEnabled && !$errors) {
        $errors[] = 'Ödeme sağlayıcısı yapılandırılmadığı için başvurunuz alınamadı. Lütfen yönetici ile iletişime geçin.';
    }
}
...
<div class="auth-wrapper">
    <div class="auth-card" style="max-width: 720px;">
        ...
        <form method="post" class="row g-3">
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-primary w-100" <?= (!$packages || !$cryptomusEnabled) ? 'disabled' : '' ?>>Ödeme Yap</button>
            </div>
