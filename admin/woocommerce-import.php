                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data" class="vstack gap-3">
                        ...
                        <div class="import-supported">
                            ...
                            <span class="import-supported-list">Name, Categories, Regular price/Price, SKU, Description, Short description, Status.</span>
                        </div>
                        <button type="submit" class="btn btn-primary">Dosyayı İçe Aktar</button>
                    </form>

                    <div class="import-divider">
                        <h6 class="fw-semibold mb-2">WooCommerce CSV Dışa Aktar</h6>
                        <p class="text-muted small mb-3">Tüm aktif ve pasif ürünlerinizi WooCommerce'in varsayılan CSV formatında dışa aktarabilirsiniz.</p>
                        <form method="post" class="d-flex flex-column flex-sm-row gap-2">
                            <input type="hidden" name="csrf_token" value="<?= Helpers::sanitize(Helpers::csrfToken()) ?>">
                            <input type="hidden" name="export_csv" value="1">
                            <button type="submit" class="btn btn-outline-primary flex-shrink-0">Ürünleri Dışa Aktar</button>
                        </form>
