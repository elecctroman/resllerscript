...
<div class="grid">
    ...
    <div class="card">
        ...
        <?php else: ?>
            ...
            <?php elseif (($statusData['status'] ?? '') === 'pending'): ?>
                <p>QR kodu alınamadı. Lütfen Selenium/Chrome hizmetinin çalıştığını ve ağ erişimi olduğunu doğrulayın, ardından sayfayı yenileyin.</p>
            <?php else: ?>
