    ...
    if (!$request) {
        ...
        try {
            ...
            if ($status === 'approved' && !$isPackageOrder && $displayEmail !== '') {
                ...
                ResellerMailer::sendBalanceApproved($userPayload, $requestPayload, $adminNote);
            }
