    ...
    if (!$order) {
        ...
        if ($newStatus === 'completed') {
            ...
            $loginMessage = "Merhaba {$order['name']},\n\n" .
                ...
                "Panel girişi: " . ($_SERVER['HTTP_HOST'] ?? 'bayi-paneli') . "\n" .
                                ...
                                <div class="modal-body">
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-8">
                                            ...
                                            <?= Helpers::sanitize($order['phone'] ?? '-') ?>
                                        </dd>
                                        <dt class="col-sm-4">Paket</dt>
                                        <dd class="col-sm-8"><?= Helpers::sanitize($order['package_name']) ?></dd>
                                        <dt class="col-sm-4">Notlar</dt>
                                        <dd class="col-sm-8"><?= nl2br(Helpers::sanitize($order['notes'] ?? '-')) ?></dd>
                                        <dt class="col-sm-4">Ek Form Verisi</dt>
                                        <dd class="col-sm-8"><pre class="bg-light p-3 rounded small"><?= Helpers::sanitize($order['form_data'] ?? '{}') ?></pre></dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
