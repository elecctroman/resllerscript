...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!Helpers::verifyCsrf($token)) {
        ...
        if ($action === 'create_provider') {
            ...
            $productsEndpoint = isset($_POST['products_endpoint']) ? trim((string) $_POST['products_endpoint']) : '/api/v1/products';
            $ordersEndpoint = isset($_POST['orders_endpoint']) ? trim((string) $_POST['orders_endpoint']) : '/api/v1/orders';
            $statusEndpoint = isset($_POST['status_endpoint']) ? trim((string) $_POST['status_endpoint']) : '/api/v1/profile';
            ...
            if (!$errors) {
                $settings = array(
                    'driver' => $driver,
                    'products_endpoint' => $productsEndpoint !== '' ? $productsEndpoint : '/api/v1/products',
                    'orders_endpoint' => $ordersEndpoint !== '' ? $ordersEndpoint : '/api/v1/orders',
                    'status_endpoint' => $statusEndpoint !== '' ? $statusEndpoint : '/api/v1/profile',
                );
                        ...
                        <div class="card card-body border-0 bg-light vstack gap-3">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="products_endpoint" class="form-control" value="/api/v1/products">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Sipariş Uç Noktası</label>
                                    <input type="text" name="orders_endpoint" class="form-control" value="/api/v1/orders">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Kimlik Doğrulama Uç Noktası</label>
                                    <input type="text" name="status_endpoint" class="form-control" value="/api/v1/profile">
                                </div>
                            </div>
                            <div>
                                            ...
                                            <div class="modal-content">
                                                <form method="post" data-provider-form>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        $editProductsEndpoint = isset($providerSettings['products_endpoint']) ? (string) $providerSettings['products_endpoint'] : '/api/v1/products';
                                                        $editOrdersEndpoint = isset($providerSettings['orders_endpoint']) ? (string) $providerSettings['orders_endpoint'] : '/api/v1/orders';
                                                        $editStatusEndpoint = isset($providerSettings['status_endpoint']) ? (string) $providerSettings['status_endpoint'] : '/api/v1/profile';
